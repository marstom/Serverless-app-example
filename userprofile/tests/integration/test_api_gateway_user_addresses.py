...
user1_new_address = {"line1": "4566 Main", "line2": "Suite 200", "city": "Seattle", "stateProvince": "WA",
                     "postal": "12345"}
user2_new_address = {"line1": "7505 Beverly Blvd", "line2": "Apt 7", "city": "Los Angeles", "stateProvince": "CA",
                     "postal": "90036"}
...
def test_add_user_address_001(global_config):
    # LOGGER.info("ID token: %s", global_config["user1UserIdToken"])
    # LOGGER.info("Endpoint: %s", global_config["ProfileApiEndpoint"])
    response = requests.post(
        global_config["ProfileApiEndpoint"] + '/address',
...
def test_update_user_address(global_config):
    ...
    updated_address_info = {"line1": "4566 Main", "line2": "Suite 200", "city": "Seattle", "stateProvince": "WA",
                            "postal": "12345"}
...
def test_delete_user_address(global_config):
    ...
    deleted_address = [a['address_id'] for a in response_data['addresses'] if
                       a['address_id'] == user1addresses['addresses'][0]['address_id']]
